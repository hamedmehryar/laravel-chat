<?php namespace Hamedmehryar\Chat\tests;
...
class EloquentThreadTest extends TestCase
{
    ...
    {
        $class = new ReflectionClass('Hamedmehryar\Chat\Models\Thread');
    ...
    public function it_should_get_a_participant_from_userid()
    {
        ...
        $this->assertInstanceOf('\Hamedmehryar\Chat\Models\Participant', $newParticipant);
    }
